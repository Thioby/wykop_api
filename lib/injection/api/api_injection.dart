...
void setupApiDeps(ApiClient client) {
  ...
  appInjector.addDependency<PmApi>(
      () => PmApi(appInjector.getDependency(), appInjector.getDependency(), appInjector.getDependency(), appInjector.getDependency()));
  appInjector
  ...
  appInjector.addDependency<EntriesApi>(() => EntriesApi(
        appInjector.getDependency(),
        appInjector.getDependency(),
        appInjector.getDependency(),
        appInjector.getDependency(),
